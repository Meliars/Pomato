    ...
    <div class="comments">
       ...
       <div class="comments__clientBox">
        <div class="comments__clientBox__ourClients">
            ...
            Blanditiis vel inventore unde reiciendis voluptatibus atque similique placeat tempora repellendus! Consequatur eos qui quibusdam eligendi dolorem quis enim, aperiam, neque esse quasi, maxime exercitationem tenetur aliquam praesentium blanditiis culpa.</p>
            <img class="comments__clientBox__ourClients__quote" src="/icon/testimonial_qoute.png">
        </div>
        <ul>
        <li></li>
        <li></li>
